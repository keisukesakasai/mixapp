...
# 注: すべてテスト用のダミーデータです。クレジットはブランド別フォーマットでスキャナー一致用。
SENSITIVE_DATA_PROMPTS = [
    "クレジットカード（Visa）4242 4242 4242 4242 で月5万円つみたてしたい。おすすめのETFは？",
    "Mastercard 5555 5555 5555 4444 で積立投資を始めたい。NISAと一般口座どちらがよい？",
    "Amex 378282246310005 で口座入金したい。手数料の仕組みを教えて。",
